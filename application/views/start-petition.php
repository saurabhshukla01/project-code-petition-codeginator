        ...
        <div class="row">
          <form action="<?php base_url();?>/petition/start-petition" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="start-petition-form">
                    ...
                    <div class="box-footer pl-4 pr-4">
                        <button type="submit" class="btn btn-primary mb-0 aqua m-t-xs bottom15-xs btn-round btnSubmit" data-toggle="modal" data-target="#previewpopup" value="form_submit" name="save" id="save" data-backdrop="static" data-keyboard="false">Submit</button>
