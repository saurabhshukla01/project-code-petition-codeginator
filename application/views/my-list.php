    ...
    <div class="row mt-5" id="my">
      ...
      <div class="col-md-12">
        <?php if(count($petitions) > 0 ) { 
               ...
               ?>                    
              <?php  if($petition_signed_count == 0 && $petition_status != 0) {
                ...
                <div class="blog-box row border mt-2 mb-2 p-2">
                  ...
                  <div class="blog-meta big-meta col-md-8 font-weight-normal">
                    <h5 class="mb-3 font-weight-bold">
                      <a href="/petition/petition-details/<?php echo $petition_uid ?>" title=""><?php echo $petition_title ?></a>
                    </h5>
                    
                    <div class="large-font"><?php echo substr($petition_description, 0,350)?></div> &nbsp;<div class="d-inline"><span class="link type-weak mt-2"><a href="/petition/petition-details/<?php echo $petition_uid ?>" class="btn btn-rounded bg-primary mt-2 text-white p-0 pl-2 pr-2"><small>Read more</small></a></span>
                    ...
                    <span class="link type-weak mt-2"><a href="<?php base_url();?>/petition/update-petition/<?php echo $petition_uid ?>" class="btn btn-rounded bg-primary mt-2 text-white p-0 pl-2 pr-2"><small>Edit Petition</small></a></span></div>
                    ...
                    <div class="pb-3 pt-2">
                      ...
                      <?php if( $petition_status == 0){
                          ...
                          echo '<span class="mr-5 pt-3 text-danger"><i class="fa fa-dropbox" aria-hidden="true"></i><small class="text-dark"><strong>&nbsp;&nbsp'.$petition_status.'</strong></small></span>';
                      } 
                      else if( $petition_status == 1 ){
                          $petition_status = 'Awaiting admin approval'; 
                           echo '<span class="mr-5 pt-3 text-danger"><i class="fa fa-pause" aria-hidden="true"></i><small class="text-dark"><strong>&nbsp;&nbsp;'.$petition_status.'</strong></small></span>';
                      }
                      else if( $petition_status == 2 ){
                          $petition_status = 'Published'; 
                          echo '<span class="mr-5 pt-3 text-danger"><i class="fa fa-rub" aria-hidden="true"></i><small class="text-dark"><strong>&nbsp;&nbsp;'.$petition_status.'</strong></small></span>';
                      }
                      ?>
                    </div>
                  </div>
    ...
    <h4 class="w-100 p-3 text-center bg-light border font-weight-bold" style="color: #097298;">SIGNED PETITION</h4>
      <div class="col-md-12">
         ...
         <?php if(count($petitions) > 0 ) { 
               ...
               ?>
               <?php  if($petition_signed_count > 0) {
                  $petition_signed_count = $petition_signed_count;
                ?>
                <div class="blog-box row border mt-2 mb-2 p-2">
                  <div class="col-md-4 pl-0 pr-0">
                  ...
                  <div class="blog-meta big-meta col-md-8 font-weight-normal">
                    ...
                    <div class="large-font"><?php echo substr($petition_description, 0,350)?><!--Record-breaking heat waves have become a regular occurrence in India, killing thousands of people. Melting snow-caps are slowly increasing the sea level.-->&nbsp;<span class="link type-weak d-block mt-2"><a href="/petition/petition-details/<?php echo $petition_uid ?>" class="btn btn-rounded bg-primary mt-2 text-white p-0 pl-2 pr-2"><small>Read more</small></a></span></div>
                    <!--<div type="submit" class="btn btn-rounded bg-primary mt-2 text-white p-0 pl-2 pr-2"><small>Edit</small></div>-->
