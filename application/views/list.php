...
<!--<main id="main" class="pt-5" style="background-color: #F5F5F5;">-->
	<section style="background-image: url('http://petition.sheenz.in/assets/img/waves.jpg'); background-size: cover; background-repeat: no-repeat; margin-top:80px;">
	    <div class="container">
	        <div class="row">
			...
			<div class="col-md-12">
				<div class="blog-list clearfix">
					<!--<div class="section-title row">
						<h3 class="pb-2 mb-4 border-bottom font-weight-normal w-100">
							<a href="#" title="">Petitions</a>
						</h3>
					</div>-->
               <!-- end title -->
