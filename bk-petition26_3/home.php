                ...
                <div class="card">
                  <div class="card-horizontal">
                    ...
                    <div class="card-body">
                       ...
                       <h4 class="card-title"><a href="/petition/petition-details/<?php echo $petition_uid ?>" title="" style="color: #097298;"><?php echo $petition_title ?></a></h4>
                       <p class="card-text"><?php echo substr($petition_description, 0,300)?>&nbsp; </p>
                        <a href="/petition/petition-details/<?php echo $petition_uid ?>" class="da-link text-white btn-info btn-sm float-right mb-4 mr-4">Read more</a>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="demo-content no-gutters">
                           <span class="text-danger"><i class="fa fa-user-plus" aria-hidden="true"></i></span>
                      ...
                      <div class="col-md-6">
                        <div class="demo-content no-gutters">
                           <span class="text-danger"><i class="fa fa-dot-circle-o" aria-hidden="true"></i></span>
                           <span class="col-11 float-right">
    ...
    <section class="media-content">
      <div class="container">
          ...
          <div class="col-md-9">
            <?php 
              ...
              <div class="grey-border load-content p-3 mb-3 white">
                ...
                <div class="row">
                  <div class="col-md-8">
                    <h4 class="media-heading pt-1 font-weight-bold"><a href="/petition/petition-details/<?php echo $petition_uid ?>" title="" style="color: #097298;"><?php echo $petition_title ?></a></h4>
                     <!--<h5 class="media-heading pt-1 font-weight-bold"><?php // echo $petition_title ?></h5>-->
                     <p><?php echo substr($petition_description, 0,300)?>&nbsp; <small><a href="/petition/petition-details/<?php echo $petition_uid ?>" class="text-danger font-italic text-white">Read More ...</a></small></p>
        ...
        <div class="col-md-3">
          ...
          <span class="badge badge-pill badge-light grey-border p-2 m-1"><a href="<?php base_url() ?>/information/filter_petition/1">Animal</a></span>
          <span class="badge badge-pill badge-light grey-border p-2 m-1"><a href="<?php base_url() ?>/information/filter_petition/2">Human rights</a></span>
          <span class="badge badge-pill badge-light grey-border p-2 m-1"><a href="<?php base_url() ?>/information/filter_petition/3">Health</a></span>
          <span class="badge badge-pill badge-light grey-border p-2 m-1"><a href="<?php base_url() ?>/information/filter_petition/4">Econamic Justice</a></span>
          <span class="badge badge-pill badge-light grey-border p-2 m-1"><a href="<?php base_url() ?>/information/filter_petition/5">Politics</a></span>
          <span class="badge badge-pill badge-light grey-border p-2 m-1"><a href="<?php base_url() ?>/information/filter_petition/6">Local</a></span>
          <span class="badge badge-pill badge-light grey-border p-2 m-1"><a href="<?php base_url() ?>/information/filter_petition/7">Environment</a></span>
          <span class="badge badge-pill badge-light grey-border p-2 m-1"><a href="<?php base_url() ?>/information/filter_petition/8">Women's rights</a></span>
       </div>
    </div>
  </div>
</section>
