          ...
          <?php if(count($petitions) > 0 ) { 
            ...
            foreach ($petitions as $petition) { 
                  ...
                  <div class="pb-2 pt-2">
                    ...
                    <?php if( $petition_status == 0){
                      $petition_status = 'Draft';
                        echo '<span class="mr-5 pt-3 text-danger"><i class="fa fa-file" aria-hidden="true"></i>&nbsp;<small class="text-dark"><strong>&nbsp;'.$petition_status.'</strong></small></span>';
                      } 
              ...
              <?php 
                 ...
                 if( $i == count($petitions)){ ?>
                    <div class="blog-box row">
                   <div class="col-md-4">
                    <div class="post-media">
                      <h4> No Signed Petition </h4>
                      <span class="text-right pb-2"><a href="<?php echo base_url();?>petition/start_petition" class="btn btn-info btn-md font-weight-bold">Please Create Petition</a></span>
                    </div>
                    <!-- end media -->
                   </div>
                 </div>
                ...
                <?php 
                  ...
                  if( $i == count($petitions)){ ?>
                   ...
                   <div class="col-md-4">
                    <div class="post-media">
                      <h4> No Signed Petition </h4>
                      <span class="text-right pb-2"><a href="<?php echo base_url();?>petition/petition-list" class="btn btn-info btn-md font-weight-bold">Please Signed Petition</a></span>
                    </div>
                    <!-- end media -->
                   </div>
                 </div>
